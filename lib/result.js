...
var debug = require('debug')('scientist:result')
var hasProperties = require('101/has-properties')
var List = require('immutable').List

function Result (experiment, observations, control) {
  debug('constructor')
 ...
 */
Result.create = function (experiment, observations, control) {
  debug('create')
 ...
 */
Result.prototype.experiment_name = function () {
 ...
 */
Result.prototype.mismatched = function () {
  debug('mismatched')
 ...
 */
Result.prototype.ignored = function () {
  debug('ignored')
 ...
 * @private
 */
Result.prototype.evaluate_candidates = function () {
  debug('evaluate_candidates')
  var mismatched = this.candidates.filter(function (candidate) {
    return !this.experiment.observations_are_equivalent(this.control, candidate)
  }.bind(this))

  mismatched.forEach(function (candidate) {
